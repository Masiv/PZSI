...
--
-- Host: 127.0.0.1
-- Generation Time: 17 Maj 2014, 23:15
...
--
-- Struktura tabeli dla tabeli `table1hgkvfjghfgih`
--

CREATE TABLE IF NOT EXISTS `table1hgkvfjghfgih` (
  `gvff` int(11) NOT NULL,
  PRIMARY KEY (`gvff`)
...
('root', '2014-05-17 10:06:02', '{"lang":"pl","collation_connection":"utf8mb4_general_ci"}');
--
-- Database: `test`
--
--
